FVP=/usr/local/FVP_RD_N1_edge/models/Linux64_GCC-9.3/FVP_RD_N1_edge
arg=" -S -R"
...
image=" -C pci.pcie_rc.ahci0.ahci.image_path=grub-rlk.img  -C board.virtioblockdevice.image_path=../busybox_arm64.ext4"
